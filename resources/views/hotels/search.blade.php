        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <form action="{{ route('hotels.search') }}" method="GET" class="hidden md:flex items-center gap-2 bg-brand-surface rounded-full px-4 py-2 flex-1 max-w-2xl mx-8 border border-brand-border hover:border-brand-muted transition-colors">
                    ...
                    <input type="text" name="destination" value="{{ request('destination') }}" placeholder="Where are you going?" class="bg-transparent border-0 focus:ring-0 text-sm flex-1 text-brand-black placeholder:text-brand-muted">
                ...
                <div class="flex items-center gap-3">
                    @auth
                        <a href="{{ route('my-bookings.index') }}" class="text-sm text-brand-text hover:text-brand-primary">My Bookings</a>
