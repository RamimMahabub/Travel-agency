                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('hotels.book.confirm') }}" id="booking-form">
                        ...
                        <div style="margin-top:20px;padding-top:20px;border-top:1px solid #e4e8ed;">
                            ...
                            <label class="payment-option" id="pay-card-label" style="opacity:0.6;">
                                <input type="radio" name="payment_method" value="card" disabled>
                                <div>
                                    <i class="fas fa-credit-card" style="font-size:18px;color:#9ca3af;"></i>
                                </div>
                                <div class="payment-option-info">
                                    <div class="title" style="color:#9ca3af;">Credit / Debit card</div>
                                    <div class="desc">Online payment — coming soon</div>
                                </div>
