...
<head>
    ...
    <title>Trawex Integration Tester</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-900 text-white font-sans antialiased p-8">
    <div class="max-w-4xl mx-auto">
        <h1 class="text-3xl font-bold mb-2">✈️ Trawex Integration Tester</h1>
    ...
    <script>
        async function runTest() {
            ...
            try {
                const response = await fetch('/api/trawex-test-execute');
